                      ...
                      <?php $userData = DB::table('users')->where('users_role', 2)->get(); ?>
                        ...
                        <tr class="gradeX">
                           ...
                           <td class="actions">
                              ...
                              &nbsp;&nbsp;&nbsp;
                              <a href="javascript::void(0)" class="on-default eye-row" onclick="viewRecords({{ $data->id }})"  data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="fa fa-eye"></i></a>
                              &nbsp;&nbsp;&nbsp;
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="form-group"> 
                        ...
                        <input  type="email" id="email" name="email" class="form-control" required="" aria-required="true" autocomplete="off" title="email" onchange="email_check()"> 
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group"> 
